...
[ExecuteInEditMode]
public class MeshTwo : MonoBehaviour {
    ...
    private void Create()
    {
        ...
        // Eckpunkte
        vertices[0] = new Vector3(0.0f, yMin, 0.0f);
        vertices[1] = new Vector3(0.0f, yMax, 0.0f);
        vertices[2] = new Vector3(-1.0f, yMin, 1.0f);
        vertices[3] = new Vector3(-1.0f, yMax, 1.0f);
        ...
        // Polygonales Netz erzeugen, Geometrie, Normalen und Topologie zuweisen
        simpleMesh = new Mesh
        {
            vertices = vertices,
            normals = normals,
